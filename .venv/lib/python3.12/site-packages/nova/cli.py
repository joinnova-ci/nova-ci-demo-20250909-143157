        ...
        with nova_lock(repo_path, wait=False):
            ...
            while state.increment_iteration():
                ...
                if test_after_review:
                    ...
                    original_branch = git_manager.repo.active_branch.name
                    
                    try:
                        # Create and checkout temp branch
                        git_manager.repo.git.checkout("-b", temp_branch)
                        ...
                        try:
                            git_manager.repo.git.checkout(original_branch)
                            git_manager.repo.git.branch("-D", temp_branch)
                        except:
                            pass
